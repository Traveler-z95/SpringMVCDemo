...
public class BlogController {
    ...
    // 查看所有博文
    @RequestMapping(value = "admin/blog/blogs", method = RequestMethod.GET)
    ...
    // 添加博文
    @RequestMapping(value = "admin/blog/blogs/add", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "admin/blog/blogs/addP", method = RequestMethod.POST)
    ...
    @RequestMapping("admin/blog/blogs/show/{id}")
    ...
    // 修改博文内容，页面
    @RequestMapping("admin/blog/blogs/update/{id}")
    ...
    // 修改博客内容，POST请求
    @RequestMapping(value = "admin/blog/blogs/updateP", method = RequestMethod.POST)
    ...
    // 删除博客文章
    @RequestMapping("admin/blog/blogs/delete/{id}")
